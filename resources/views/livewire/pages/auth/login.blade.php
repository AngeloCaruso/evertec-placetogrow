...
<div>
    ...
    <form wire:submit="login">
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <a href="{{ route('register') }}" class="ms-4 text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500" wire:navigate>Register</a>
            @endif
