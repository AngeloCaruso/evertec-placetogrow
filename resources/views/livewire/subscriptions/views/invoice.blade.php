    ...
    <div class="px-4 py-5 sm:p-6">
        ...
        <div class="text-center mt-3">
            ...
            <p class="text-sm text-gray-500 dark:text-neutral-500">
                {{__('Reference')}}: {{ $subscription->data->reference }}
            </p>
        </div>
        ...
        <div class="mt-5 sm:mt-10 flex flex-wrap justify-center gap-10">
            ...
            <div class="text-center">
                <span class="block text-xs uppercase text-gray-500 dark:text-neutral-500">{{__('Subscription Date')}}</span>
                <span class="block text-sm font-medium text-gray-800 dark:text-neutral-200">
            ...
            <div class="text-center">
                <span class="block text-xs uppercase text-gray-500 dark:text-neutral-500">{{__('Subscription Status')}}</span>
                <span class="block text-sm font-medium text-gray-800 dark:text-neutral-200 ">
                    {{ __($subscription->data->status_label) }}
                </span>
            </div>
        </div>

        <div class="mt-5 sm:mt-10">
            <h4 class="text-xs font-semibold uppercase text-gray-800 dark:text-neutral-200">{{__('Subscription data')}}</h4>
            ...
            <ul class="mt-3 flex flex-col">
                ...
                <li
                    class="inline-flex items-center gap-x-2 py-3 px-4 text-sm border text-gray-800 -mt-px first:rounded-t-lg first:mt-0 last:rounded-b-lg dark:border-neutral-700 dark:text-neutral-200">
                    <div class="flex items-center justify-between w-full">
                        <span>{{ __('Subscription Price') }}</span>
